 ...
 * modification from original by John Kiragu(mutuakiragu@gmail.com)
 */
 ...
 class Authentication
 {
  ...
  /**
   * @TODO change this method to use a user object as an auth_identifiers
   ...
   * @TODO Change this to use ACL after editing ACL values
   * To include Auth leveld for application values
   *
