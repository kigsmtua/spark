                ...
                <div class="pull-right">
                    ...
                    <div class="btn-group btn-group-list btn-group-notification">
                        ...
                        <div class="dropdown-menu pull-right">
                            ...
                            <ul class="media-list dropdown-list">
                                <li class="media">
                                    <img class="img-circle pull-left noti-thumb" src="<?php echo base_url()?>themes/default/images/photos/user1.png" alt="">
                                ...
                                <li class="media">
                                    <img class="img-circle pull-left noti-thumb" src="<?php echo base_url()?>themes/default/images/photos/user2.png" alt="">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="img-circle pull-left noti-thumb" src="<?php echo base_url()?>themes/default/images/photos/user3.png" alt="">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="img-circle pull-left noti-thumb" src="<?php echo base_url()?>themes/default/images/photos/user4.png" alt="">
                                    <div class="media-body">
                    ...
                    <div class="btn-group btn-group-option">
                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                          ...
                          <li class="divider"></li>
                          <li><a href="<?php echo  base_url()?>auth/login/destroy"><i class="glyphicon glyphicon-log-out"></i>Sign Out</a></li>
                        </ul>
                    </div><!-- btn-group -->
            ...
            <div class="leftpanel">
                <div class="media profile-left">
                    <a class="pull-left profile-thumb" href="profile.html">
                        <img class="img-circle" src="<?php echo base_url()?>themes/default/images/photos/profile.png" alt="">
                    </a>
                    <div class="media-body">
